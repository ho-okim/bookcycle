                                ...
                                <tbody>
                                    <tr>
                                        <td align="center" style="line-height:1.5 !important;">
                                            <p>안녕하세요, 북사이클입니다.</p>
                                            <p>북사이클의 회원이 되신 것을 환영홥니다!</p>
                                            <p>링크를 클릭해 <strong style="font-size:18px;"><a href="http://localhost:10000/verify?email=${email}&token=${token}">회원가입 인증</a></strong> 절차를 완료해주시기 바랍니다.</p>
